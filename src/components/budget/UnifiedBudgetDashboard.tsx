    ...
    <div className="space-y-6">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Overall spending limit</p>
              </div>
            </div>
          ...
          {isEditingBudget ? (
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500">Your total spending limit</p>
            </div>
          )}
      ...
      <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl border border-white/5">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Track spending by category</p>
              </div>
            </div>
          ...
          <CategoryBudgetList onEdit={handleEditBudget} />
        </div>
      </div>
